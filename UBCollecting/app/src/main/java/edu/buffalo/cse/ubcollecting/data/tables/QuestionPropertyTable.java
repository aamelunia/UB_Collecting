...
public class QuestionPropertyTable {
    ...
    public static String createTable(){
        return "CREATE TABLE "
                + QuestionProperty.TABLE + "(" + QuestionProperty.KEY_QUESTION_ID + " TEXT,"
                + QuestionProperty.KEY_QUESTION_PROPERTY_ID + " TEXT," + QuestionProperty.KEY_QUESTION_PROPERTY_VALUE + " INTEGER,"
                + "PRIMARY KEY("+ QuestionProperty.KEY_QUESTION_ID+", "+QuestionProperty.KEY_QUESTION_PROPERTY_ID+"),"
